...
def kdaj_kupiti_katerega_ta_dela(podatki):
    ...
    :param: sprejme osnoven indeks: podatki
    :return: rezultat v print-ih
    """
    print("Glavna funkcija laufa!")
    osnoven_indeks = izracun_dnevnih_sprememb(podatki)
    leverage_indeks = calculate_leverage(podatki)
   ...
   #da vemo kateremu pristet zacetno
    ...
    print(f"V Navadnem indeksu imamo: {formatiraj_kes_eur(investment_navaden)}, v Leverage imamo: {formatiraj_kes_eur(investment_leverage)},skupaj; {formatiraj_kes_eur(investment_navaden + investment_leverage)}")
